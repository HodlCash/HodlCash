...
public:
    ...
    void setZHDLCControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzHDLC_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzHDLC_clicked();
    void on_pushButtonZHDLCControl_clicked();

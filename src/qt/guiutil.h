...
/** Utility functions used by the HodlCash Qt UI.
 */
namespace GUIUtil
{
...
// Render HodlCash addresses in monospace font
...
// Parse "HodlCash:" URI into recipient object, return true on successful parsing

...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHDLC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HodlCash Core"), this);
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HodlCash"));
...
{
    QString strTitle = tr("HodlCash Core"); // default title

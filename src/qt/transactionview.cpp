 ...
 */
    ...
    typeWidget->addItem(tr("Received HDLC from zHDLC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zHDLC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zHDLC));

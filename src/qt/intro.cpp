...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("HodlCash Core"),
     ...
     * override -datadir in the HodlCash.conf file in the default data directory
     * (to be consistent with HodlCashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop HodlCash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "HodlCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HodlCash features */
        {"HodlCash", "masternode", &masternode, true, true, false},
        {"HodlCash", "listmasternodes", &listmasternodes, true, true, false},
        {"HodlCash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"HodlCash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"HodlCash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"HodlCash", "masternodedebug", &masternodedebug, true, true, false},
        {"HodlCash", "startmasternode", &startmasternode, true, true, false},
        {"HodlCash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"HodlCash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"HodlCash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"HodlCash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"HodlCash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"HodlCash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"HodlCash", "mnbudget", &mnbudget, true, true, false},
        {"HodlCash", "preparebudget", &preparebudget, true, true, false},
        {"HodlCash", "submitbudget", &submitbudget, true, true, false},
        {"HodlCash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"HodlCash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"HodlCash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"HodlCash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"HodlCash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"HodlCash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"HodlCash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"HodlCash", "checkbudgets", &checkbudgets, true, true, false},
        {"HodlCash", "mnsync", &mnsync, true, true, false},
        {"HodlCash", "spork", &spork, true, true, false},
        {"HodlCash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"HodlCash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> HodlCash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:46201/\n";
}

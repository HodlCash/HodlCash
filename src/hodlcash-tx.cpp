...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HodlCash Core HodlCash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  HodlCash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded HodlCash transaction") + "\n" +
                               "  HodlCash-tx [options] -create [commands]   " + _("Create hex-encoded HodlCash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded HodlCash transaction

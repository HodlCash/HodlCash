...
// Copyright (c) 2019 The HodlCash Core Development Team
...
public:
    CMainParams()
    {
        ...
        const char* pszTimestamp = "NocNoc arrives while florida man fends off alligator with a anal beads Aug 15th 2019";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1565895847;
        genesis.nBits = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce = 2528835;
        hashGenesisBlock = genesis.GetHash();

        assert(hashGenesisBlock == uint256("0x00000dd6982f42c51a9205605a199aa85afb19c24820f17d83e3fa334df9c134"));
        assert(genesis.hashMerkleRoot == uint256("0x858df9bd727d4670e7ad7fdff052163c5600c77f86d5a76a9515b3e10146378a"));
	...
	vSeeds.push_back(CDNSSeedData("134.122.112.177", "134.122.112.177"));
        //ipv6
...
public:
    CTestNetParams()
    {
        ...
        // Testnet HodlCash BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet HodlCash BIP44 coin type is '1' (All coin's testnet default)

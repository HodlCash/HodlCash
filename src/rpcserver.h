...
/**
 * HodlCash RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern UniValue initmasternode(const UniValue& params, bool fHelp);
extern UniValue masternodeisinit(const UniValue& params, bool fHelp);
extern UniValue killmasternode(const UniValue& params, bool fHelp);

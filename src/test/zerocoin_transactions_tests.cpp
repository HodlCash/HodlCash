// Copyright (c) 2012-2014 The HodlCash Core developers
...
BOOST_AUTO_TEST_CASE(zerocoin_spend_test)
{
    ...
    BOOST_CHECK_MESSAGE(receipt.GetStatus() == ZHDLC_TRX_FUNDS_PROBLEMS, "Failed Invalid Amount Check");
    ...
    BOOST_CHECK_MESSAGE(receipt2.GetStatus() == ZHDLC_TRX_FUNDS_PROBLEMS, "Failed Invalid Amount Check");

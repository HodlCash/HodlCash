...
# Copyright (c) 2019 The hodlcashHash developers
...
pkgdatadir = $(datadir)/hodlcashhash
pkgincludedir = $(includedir)/hodlcashhash
pkglibdir = $(libdir)/hodlcashhash
pkglibexecdir = $(libexecdir)/hodlcashhash
...
CONFIG_HEADER = $(top_builddir)/src/config/hodlcashhash-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/hodlcashhash-config.h.in \
...
ACLOCAL = ${SHELL} /home/oem/Desktop/hodlcashhash/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/oem/Desktop/hodlcashhash/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/oem/Desktop/hodlcashhash/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/oem/Desktop/hodlcashhash/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = hodlcashhash-cli
BITCOIN_DAEMON_NAME = hodlcashhashd
BITCOIN_GUI_NAME = hodlcashhash-qt
BITCOIN_TX_NAME = hodlcashhash-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/oem/Desktop/hodlcashhash/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL = 
OTOOL64 = 
PACKAGE = hodlcashhash
PACKAGE_BUGREPORT = www.hodlcashhash.io
PACKAGE_NAME = hodlcashHash Core
PACKAGE_STRING = hodlcashHash Core 2.0.0
PACKAGE_TARNAME = hodlcashhash
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/oem/Desktop/hodlcashhash
abs_srcdir = /home/oem/Desktop/hodlcashhash
abs_top_builddir = /home/oem/Desktop/hodlcashhash
abs_top_srcdir = /home/oem/Desktop/hodlcashhash
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/oem/Desktop/hodlcashhash/build-aux/install-sh
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/hodlcash.icns
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_hodlcash_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_hodlcash_coverage.info test_hodlcash.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/hodlcash.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/hodlcashHash-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/hodlcashhash-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/hodlcashhash-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/hodlcashhash-config.h
$(top_srcdir)/src/config/hodlcashhash-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/hodlcashhash-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/Resources/hodlcash.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@

$(OSX_APP)/Contents/MacOS/hodlcashHash-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/hodlcashHash-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/hodlcashHash-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_hodlcash.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_hodlcash -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_hodlcash_filtered.info: test_hodlcash.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_hodlcash_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_hodlcash_coverage.info: baseline_filtered_combined.info test_hodlcash_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_hodlcash_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_hodlcash_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_hodlcash_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_hodlcash.coverage/.dirstamp:  test_hodlcash_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_hodlcash.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_hodlcash.coverage/ total.coverage/ $(OSX_APP)

...
# Copyright (c) 2019 The HodlCash Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.

# Configuration settings
projectName="hodlcash"				# The name of the wallet or project
...
walletOutputDirectory="HDLC-binaries"		# The directory where finished wallets will be stored
...
githubRepo="HDLC"				# The name of the repo for the wallet project. Ie: repo name = gitian-builder from https://github.com/devrandom/gitian-builder
githubDetachedSigsRepo="hodlcash-detached-sigs"	# The name of the repo for the detached signatures.
